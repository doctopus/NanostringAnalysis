...
library(openxlsx)
getwd()
setwd("/Users/i/Dropbox/Clinic3.0/Developer/RStudio/NanostringAnalysis/Nanostring-ANS/jing_heatmap")

data <- read.table("Jenifer_Yu_Spatial_Protein_Dataset.txt", header = TRUE, sep = "\t")
